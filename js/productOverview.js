        ...
        <div class="bg-white w-full grid grid-cols-1 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)] gap-6 lg:gap-8">
          <div class="flex flex-col h-full">
            <div class="relative flex-1 flex items-start justify-start overflow-hidden min-h-0 min-w-0 bg-[#f5f5f5] touch-manipulation select-none" id="image-container">
              <button type="button" class="main-carousel-prev absolute left-3 top-1/2 -translate-y-1/2 z-20 w-9 h-9 lg:w-10 lg:h-10 flex items-center justify-center text-xl lg:text-2xl font-normal transition-all duration-200 rounded-full hover:bg-opacity-90" style="outline:none; border:none; background: rgba(0,0,0,0.7); color: white; backdrop-filter: blur(4px); line-height: 1; font-family: monospace; pointer-events: auto;">
                &lt;
              </button>
              ...
              <button type="button" class="main-carousel-next absolute right-3 top-1/2 -translate-y-1/2 z-20 w-9 h-9 lg:w-10 lg:h-10 flex items-center justify-center text-xl lg:text-2xl font-normal transition-all duration-200 rounded-full hover:bg-opacity-90" style="outline:none; border:none; background: rgba(0,0,0,0.7); color: white; backdrop-filter: blur(4px); line-height: 1; font-family: monospace; pointer-events: auto;">
                &gt;
              </button>
            </div>
